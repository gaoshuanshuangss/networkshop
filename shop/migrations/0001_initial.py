    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.goods')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gdname', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.goodsdetailname')),
                ('goods', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.goods')),
            ],
        ),
    ]
